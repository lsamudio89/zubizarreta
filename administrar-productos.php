    ...
    <script type="text/javascript">
		...
		$(document).ready(function () {
			...
			function iconoEditar(value, row, index) {
				return [
					<?php if ($id_rol==1) echo "'<button type=\"button\" onclick=\"javascript:void(0)\" class=\"btn btn-primary btn-xs editar\"><span class=\"glyphicon glyphicon-edit aria-hidden=\"true\"></span>&nbsp;&nbsp;Editar</button>&nbsp;&nbsp;&nbsp;',"; ?>
					'<button type="button" onclick="javascript:void(0)" class="btn btn-info btn-xs imprimir"><span class="glyphicon glyphicon-barcode aria-hidden="true"></span>&nbsp;&nbsp;Imprimir Etiqueta</button>'
			...
			$table.bootstrapTable({
				...
				columns: [
					[
						{	field: 'id_producto', align: 'left', valign: 'middle', title: 'ID Producto', sortable: true	}, 
						{	field: 'producto', align: 'left', valign: 'middle', title: 'Nombre / Descripción', sortable: true	},
						{	field: 'stock', align: 'right', valign: 'middle', title: 'Stock', sortable: true	},
						{	field: 'stock_minimo', align: 'center', valign: 'middle', title: 'Stock Mín', sortable: true	},
						{	field: 'costo', align: 'right', valign: 'middle', title: 'Costo', sortable: true	},
						{	field: 'precio_vta_min', align: 'right', valign: 'middle', title: 'Precio Minorista', sortable: true	},
						{	field: 'precio_vta_may', align: 'right', valign: 'middle', title: 'Precio Mayorista', sortable: true	},
						{	field: 'precio_distribuidor', align: 'right', valign: 'middle', title: 'Precio Distribuidor', sortable: true, visible:false	},
						{	field: 'ganancia_min', align: 'right', valign: 'middle', title: 'Ganancia Min.', sortable: true	},
						{	field: 'ganancia_may', align: 'right', valign: 'middle', title: 'Ganancia May.', sortable: true	},
				...
				<div class="col-md-12">
					...
					<div id="toolbar">
						...
						<div class="form-inline" role="form">
							...
							<?php if ($id_rol==1) echo "
								<button type='button' class='btn btn-primary form-control' id='agregar' data-toggle='modal' data-target='.modal-agregar'>Agregar Producto</button>";
							?>
							</div>
						</div>
					</div>
		...
		<div class="modal-dialog modal modal-md">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Agregar Producto<a href="#mySmallModalLabel" class="anchorjs-link"><span class="anchorjs-icon"></span></a></h4>
				</div>
								...
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="row">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="producto_carga">Nombre / Descripción del Producto</label>
												<input class="form-control input-sm" type="text" name="producto_carga" id="producto_carga" autocomplete="off">
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="precio_vta_may_carga">Precio Distribuidor</label>
												<input class="form-control input-sm" id="precio_distribuidor_carga" name="precio_distribuidor_carga" type="text" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)">
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="stock_minimo_carga">Stock Mínimo</label>
												<input class="form-control input-sm" id="stock_minimo_carga" name="stock_minimo_carga" type="text" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)">
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="precio_vta_min_carga">Precio Minorista</label>
												<input class="form-control input-sm" id="precio_vta_min_carga" name="precio_vta_min_carga" type="text" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)">
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="precio_vta_may_carga">Precio Mayorista</label>
												<input class="form-control input-sm" id="precio_vta_may_carga" name="precio_vta_may_carga" type="text" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)">
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="form-group no-margin">
												<button title="Añadir más fotos" style="border-width:0" type="button" class="btn btn-info btn-xs" onclick="agregarDOMImg('carga');">
												<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;Agregar Fotos</button>
												<br>
												<div id="div_fotos_carga"></div>
											</div>
										</div>
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="row">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="producto_editar">Nombre / Descripción del Producto</label>
												<input class="form-control input-sm" type="text" name="producto_editar" id="producto_editar" autocomplete="off">
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="precio_vta_may_editar">Precio Distribuidor</label>
												<input class="form-control input-sm" id="precio_distribuidor_editar" name="precio_distribuidor_editar" type="text" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												...
												<input class="form-control input-sm" id="stock_minimo_editar" name="stock_minimo_editar" type="text" autocomplete="off" onkeyup="separadorMilesOnKey(event,this)">
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="costo_editar">Costo</label>
												<input class="form-control input-sm" id="costo_editar" name="costo_editar" type="text" autocomplete="off" onkeyup="separadorMilesOnKey(event,this);calculoGananciaMin();calculoGananciaMay()">
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="precio_vta_min_editar">Precio Vta. Minorista</label>
												<input class="form-control input-sm" id="precio_vta_min_editar" name="precio_vta_min_editar" type="text" autocomplete="off" onkeyup="separadorMilesOnKey(event,this);calculoGananciaMin()">
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="precio_vta_may_editar">Precio Vta. Mayorista</label>
												<input class="form-control input-sm" id="precio_vta_may_editar" name="precio_vta_may_editar" type="text" autocomplete="off" onkeyup="separadorMilesOnKey(event,this);calculoGananciaMay()">
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="stock">Stock en esta Sucursal</label>
												<p id="stock" class="p_info"></p>
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="ganancia_min">Ganancia Minorista</label>
												<p class="p_info" id="ganancia_min"></p>
											</div>
										</div>
										<div class="col-md-3 col-sm-6 col-xs-12">
											<div class="form-group">
												<label for="ganancia_may">Ganancia Mayorista</label>
												<p class="p_info" id="ganancia_may"></p>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="form-group no-margin">
												<button title="Añadir más fotos" style="border-width:0" type="button" class="btn btn-info btn-xs" onclick="agregarDOMImg('editar');">
												<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp;Agregar Fotos</button>
												<br>
												<div id="div_fotos_editar"></div>
											</div>
										</div>
									</div>
									<br>
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											...
											<button onclick="preguntaBorrado($('#producto_editar').val())" type="button" class="btn btn-danger btn-md submit_btn" style="float:left">Eliminar Producto</button>
