<?php
	include 'inc/reporte-historial-flete-data.php';
    ...
    <script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$table.bootstrapTable({
				columns: [
					[
						{	field: 'id_compra_detalle', title: 'ID', align: 'center', valign: 'middle', sortable: true },
						...
						{	field: 'flete', align: 'right', valign: 'middle', title: 'Flete'	},
						{	field: 'despacho', align: 'right', valign: 'middle', title: 'Despacho'	},
						{	field: 'costo', align: 'right', valign: 'middle', title: 'Costo', sortable: true	},
						{	field: 'total', align: 'right', valign: 'middle', title: 'Costo Final', sortable: true	},
...
<table id="tabla" data-url="inc/reporte-historial-flete-data.php?q=ver&id_sucursal=<?php echo $id_sucursal;?>&id_producto=<?php echo $id_producto;?>" data-toolbar="#toolbar" data-show-export="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search-align="right" data-buttons-align="right" data-toolbar-align="left"
    ...
    window.print();
	  ...
	  $( function(){
	    ...
	    $("#producto").autocomplete({
	      minLength: 0,
	      source: "inc/reporte-historial-flete-data.php?q=buscar_producto&id_sucursal="+id_sucursal,
