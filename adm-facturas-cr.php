  ...
  <head>
    ...
    <script type="text/javascript">
			...
			$('#tabla').bootstrapTable({
				...
				columns: [
					[
						...
						{	field: 'cantidad', title: 'Cant.', align: 'center', valign: 'middle', sortable: true,visible:false }, 
		...
		function deshabilitar(){
			...
			$.ajax({
				dataType: 'json', async: false, cache: false, url: 'inc/adm-facturas-data-cr.php', type: 'POST', data: {q: 'filtrar_estado', estado_factura: estado_factura},
				beforeSend: function(){
					$("#mensaje").html("<img src='images/progress_bar.gif'>");
				},
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div id="toolbar">
							...
							<div class="form-group">
                                                            <label for="tipo_editar">Estados : </label>
                                                            <select class='form-control input-sm' name='estado_factura' id='estado_factura' onchange=RecargarFacturas();>
