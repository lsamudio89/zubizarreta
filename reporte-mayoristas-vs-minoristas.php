   ...
   <script type="text/javascript">
		$(document).ready(function () {
			$("#tabla").bootstrapTable({
				...
				columns: [
					[
						{	field: 'sucursal', align: 'left', valign: 'middle', title: 'Sucursal', sortable: true, footerFormatter: totales },
						{	field: 'tipo_venta', align: 'left', valign: 'middle', title: 'Tipo de Cliente', sortable: true	}, 
						{	field: 'total_costo', align: 'right', valign: 'middle', title: 'Total Costo', sortable: true, footerFormatter: sumatoria	},
						{	field: 'total_a_pagar', align: 'right', valign: 'middle', title: 'Total Venta', sortable: true, footerFormatter: sumatoria	},
						{	field: 'ganancias', align: 'right', valign: 'middle', title: 'Ganancias', sortable: true, footerFormatter: sumatoria	},
					]
				]
			});

	
			//Altura de tabla_mayorista automatica
			...
			function sumatoria(data) {
				...
				return '<b style="font-size:16px">'+moneda+separadorMiles(total)+'</b>';
			}
		...
		function recargarDatos(desde,hasta){
			...
			var datos;
			$.ajax({
				dataType: 'json', async: false, cache: false, url: 'inc/reporte-may-vs-min-data.php', type: 'POST', data: {id_sucursal: id_sucursal, desde: desde, hasta: hasta},
				beforeSend: function(){
					$("#mensaje").html("<img src='images/progress_bar.gif'>");
				},
				success: function (json){
   ...
   <!-- Fixed navbar -->
	...
	<div id="wrap">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div id="toolbar"><h2><?php echo nombrePagina(basename($_SERVER['PHP_SELF'])); ?></h2>
					...
					<table id="tabla" data-url="inc/reporte-may-vs-min-data.php" data-toolbar="#toolbar" data-show-export="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search-align="right" data-buttons-align="right" data-toolbar-align="left" data-pagination="false" data-classes="table table-hover table-condensed" data-show-footer="true" data-group-by="true" data-group-by-field="sucursal"></table>
				</div>
			</div>
