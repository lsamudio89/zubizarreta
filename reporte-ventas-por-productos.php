  ...
  <head>
   ...
   <script type="text/javascript">
	$(document).ready(function () {
			...
			$.ajax({
				dataType: 'json', async: false, cache: false, url: 'inc/rep-ventas-por-productos-data.php', type: 'POST', data: {id_sucursal: <?php echo $id_sucursal; ?>},
				beforeSend: function(){
					$("#mensaje").html("<img src='images/progress_bar.gif'>");
				},
				success: function (json){
			...
			$table.bootstrapTable({
				...
				columns: [
					[
						{	field: 'id_producto', align: 'left', valign: 'middle', title: 'ID Producto', sortable: true, width:'10%'	},
						{	field: 'producto', align: 'left', valign: 'middle', title: 'Producto', sortable: true	}, 
						{	field: 'cantidad', align: 'center', valign: 'middle', title: 'Cantidad', sortable: true, footerFormatter: sumatoria, width:'10%'	},
						{	field: 'costo', align: 'right', valign: 'middle', title: 'Costo', sortable: true, footerFormatter: sumatoria, width:'10%'	},
						{	field: 'precio_venta', align: 'right', valign: 'middle', title: 'Precio Venta', sortable: true, footerFormatter: sumatoria, width:'10%'	},
						{	field: 'total_costo', align: 'right', valign: 'middle', title: 'Total Costo', sortable: true, footerFormatter: sumatoria, width:'10%'	},
						{	field: 'total_venta', align: 'right', valign: 'middle', title: 'Total Venta', sortable: true, footerFormatter: sumatoria, width:'10%'	},
						{	field: 'ganancia', align: 'right', valign: 'middle', title: 'Ganancia', sortable: true, footerFormatter: sumatoria, width:'10%'	},
						{	field: 'tipo_venta', align: 'right', valign: 'middle', title: 'Tipo Cliente', sortable: true, width:'10%'	},
					]
				]
			});
			...
			function sumatoria(data) {
				...
				return '<b style="font-size:14px">'+moneda+separadorMiles(total)+'</b>';
			}
	...
	function recargarDatos(desde,hasta){
			...
			var datos;
			$.ajax({
				dataType: 'json', async: false, cache: false, url: 'inc/rep-ventas-por-productos-data.php', type: 'POST', data: {id_sucursal: id_sucursal, desde: desde, hasta: hasta},
				beforeSend: function(){
					$("#mensaje").html("<img src='images/progress_bar.gif'>");
				},
				success: function (json){
