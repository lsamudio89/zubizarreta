			...
			$('#sucursal').change(function(){
				...
				$.ajax({
					...
					success: function (datos){
						...
						$("#contenido_tabla").append("<tr><td data-editable='false' style='width:20px'>"+value.id_producto+"</td><td data-editable='false' style='text-align:left'>"+value.producto+"</td><td data-editable='false'>"+value.stock_minimo+"</td><td data-editable='false'>"+value.stock+"</td><td data-editable='false'>"+value.costo+"</td><td data-editable='false'>"+value.total_costo+"</td><td data-editable='false'>"+value.precio_vta_min+"</td><td data-editable='false'>"+value.total_vta_min+"</td><td data-editable='false'>"+value.precio_vta_may+"</td><td data-editable='false'>"+value.total_vta_may+"</td></tr>");
						});
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="form-inline" role="form">
						<form method="GET">
							<input type="hidden" name="sucursal" id="sucursal" readonly>
							&nbsp;&nbsp;&nbsp;&nbsp;
