  ...
  <head>
   ...
   <script type="text/javascript">
	$(document).ready(function () {
			...
			$.ajax({
				dataType: 'json', async: false, cache: false, url: 'inc/rep-productos-vendidos-data.php', type: 'POST', data: {id_sucursal: <?php echo $id_sucursal; ?>},
				beforeSend: function(){
					$("#mensaje").html("<img src='images/progress_bar.gif'>");
				},
				success: function (json){
	...
	function recargarDatos(desde,hasta){
			...
			var datos;
			$.ajax({
				dataType: 'json', async: false, cache: false, url: 'inc/rep-productos-vendidos-data.php', type: 'POST', data: {id_sucursal: id_sucursal, desde: desde, hasta: hasta},
				beforeSend: function(){
					$("#mensaje").html("<img src='images/progress_bar.gif'>");
				},
				success: function (json){
